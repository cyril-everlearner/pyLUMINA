...
For a uniformly (gaussian waist is thus very large!) illuminated disk aperture with a width of a=1mm, a distance of D=1m, and a wavelength of lambda=1µm, 
The central lobe diameter d is given by d = 2.44 * lambda * D / a = 2.44 * 1e-6 * 1 / 1e-3 = 2.44mm. 
