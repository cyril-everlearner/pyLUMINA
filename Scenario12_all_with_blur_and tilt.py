...
ttk.Label(frame, text="Tilt phase (rad):").grid(row=len(parameters) + 3, column=0, sticky=tk.W)
entry_tilt = ttk.Entry(frame, width=15)
entry_tilt.grid(row=len(parameters) + 3, column=1)
...
entry_blur_sigma.insert(0, ".6")  # Valeur par défaut
