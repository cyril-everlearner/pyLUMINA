...
ttk.Label(frame, text="Tilt phase (rad):").grid(row=len(parameters) + 4, column=0, sticky=tk.W)
entry_tilt = ttk.Entry(frame, width=15)
entry_tilt.grid(row=len(parameters) + 4, column=1)
...
checkbox_blur.grid(row=len(parameters) + 5, column=2, sticky=tk.W)

# Blur sigma value (gaussian filter)
ttk.Label(frame, text="Sigma (pixels):").grid(row=len(parameters) + 5, column=0, sticky=tk.W)
entry_blur_sigma = ttk.Entry(frame, width=15)
entry_blur_sigma.grid(row=len(parameters) + 5, column=1)
entry_blur_sigma.insert(0, "1.2")  # Valeur par défaut


# Nonlinear index n2
ttk.Label(frame, text="Nonlinear Index n2 (m²/W):").grid(row=len(parameters) + 6, column=0, sticky=tk.W)
entry_n2 = ttk.Entry(frame, width=15)
entry_n2.grid(row=len(parameters) + 6, column=1)
entry_n2.insert(0, "0")
...
checkbox_3D.grid(row=len(parameters) + 7, column=2, sticky=tk.W)

# Colormap selection menu
colormap_var = tk.StringVar(value="berlin")
colormap_label = ttk.Label(frame, text="Colormap:")
colormap_label.grid(row=len(parameters) + 7, column=0, sticky=tk.W)
...
colormap_menu.grid(row=len(parameters) + 7, column=1)
...
button_run.grid(row=len(parameters) + 10, column=1)
